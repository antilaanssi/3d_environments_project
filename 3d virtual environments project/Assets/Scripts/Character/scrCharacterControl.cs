...
public class scrCharacterControl : MonoBehaviour
{
  ...
  /*  #region - isShooting -
    ...
    private void CalculateView(){
        ...
        newCameraRotation.x += (isAimingIn ? playerSettings.ViewXSensitivity * playerSettings.AimingSensitivityEffector : playerSettings.ViewYSensitivity) * (playerSettings.ViewYinverted ? input_View.y : -input_View.y) * Time.deltaTime;
